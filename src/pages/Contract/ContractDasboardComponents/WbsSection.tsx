...
export function WbsSection({
  ...
  const calculateBudgetUtilization = useCallback((wbsId: string) => {
    ...
    if (!wbs || !wbs.budget || wbs.budget <= 0) return 0;
                  ...
                  >
                    ...
                    <div className="flex items-center">
                      <div className="text-right mr-4">
                        <div className="text-sm font-medium">{formatCurrency(wbs.budget)}</div>
                  ...
                  {isExpanded && (
                    <div className="p-4 pt-0 border-t border-gray-700">
                      <div className="text-sm text-gray-300 whitespace-pre-line mb-4">
                        {wbs.scope || 'No scope description available.'}
                      </div>
