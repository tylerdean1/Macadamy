-- Align complete_my_profile RPC signature with nullable onboarding fields used by frontend
CREATE OR REPLACE FUNCTION public.complete_my_profile(
  p_full_name text,
  p_phone text DEFAULT NULL::text,
  p_job_title_id uuid DEFAULT NULL::uuid,
  p_avatar_id uuid DEFAULT NULL::uuid,
  p_role public.user_role_type DEFAULT NULL::public.user_role_type,
